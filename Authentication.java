...
/**
*
* @author Sanket Mohanty(theSanketmohanty)
*/
...
public class Authentication extends JFrame {
	...
	public Authentication() {
		...
		JLabel lblCopyrightscTheSanketmohanty = new JLabel("Copyrights(c) TheSanketmohanty 2021.");
		lblCopyrightscTheSanketmohanty.setHorizontalAlignment(SwingConstants.TRAILING);
		lblCopyrightscTheSanketmohanty.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblCopyrightscTheSanketmohanty.setBounds(163, 306, 283, 23);
		getContentPane().add(lblCopyrightscTheSanketmohanty);
